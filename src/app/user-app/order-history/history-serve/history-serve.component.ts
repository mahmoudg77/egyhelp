...
@Component({
  selector: 'app-history-serve',
  templateUrl: './history-serve.component.html',
  styleUrls: ['./history-serve.component.scss'],
})
export class HistoryServeComponent implements OnInit {
  dats: any[];
  complaints: any[];
  ...
  ngOnInit() {
   ...
   // console.log(this.route.params);
      this.route.parent.params.subscribe(params=>{
        ...
        this.order.getOrderServes(+params['id'],
        next=>{
            this.dats=next;
            this.getComplaints();
